...
const ClassPage = () => {
    ...
    const columns: Columns[] = [
        ...
        { field: "nb_etud", headerName: "N° d'étudiants", type: "number", add: true, edit: true, required: true },
        {
            field: "active",
            headerName: "Etat",
            type: "string",
                    ...
                    .then((res : any) => {
                      ...
                      if (res.status === 200) {
                        Swal.fire({
                          position: "center",
                          icon: "success",
                          title: `${res.data.name ?? "Class"} a bien été désactivé`,
                          showConfirmButton: false,
                          timer: 1500,
                        });
                        setrefresh(!refresh)
                        ...
                        Swal.fire({
                          position: "center",
                          icon: "error",
                          title: `${res.data.name ?? "Class"} n'a pas été désactivé`,
                          showConfirmButton: false,
                          timer: 1500,
                        });
                      }
