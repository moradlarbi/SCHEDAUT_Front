...
const CoursePage = () => {
  ...
  return (
      <>
      {openDialog && <NewCourse handleClose={() => setOpenDialog(false)} handleCloseUpdated={() => {
            Swal.fire({
              icon: "warning",
              title: "Êtes-vous sûr ?",
    ...
    <Box>
        <Border
        title="Modules"
        subtitle="Visualiser, modifier ou gérer vos modules."
        actions={[
            {
                label: `Désactiver (${
                    ...
                    .then((res : any) => {
                      ...
                      if (res.status === 200) {
                        Swal.fire({
                          position: "center",
                          icon: "success",
                          title: `${res.data.name ?? "Module"} a bien été désactivé`,
                          showConfirmButton: false,
                          timer: 1500,
                        });
                        setrefresh(!refresh)
                        ...
                        Swal.fire({
                          position: "center",
                          icon: "error",
                          title: `${res.data.name ?? "Module"} n'a pas été désactivé`,
                          showConfirmButton: false,
                          timer: 1500,
                        });
                      }
                    ...
                    .catch((e: any) => {
                      console.log(e)
                        Swal.fire({
                          position: "center",
                          icon: "error",
                          title: `Module n'a pas été désactivé`,
                          showConfirmButton: false,
                          timer: 1500,
                        });
